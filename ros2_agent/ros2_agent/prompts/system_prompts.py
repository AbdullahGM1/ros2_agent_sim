...
def system_prompts() -> RobotSystemPrompts:
    ...
    return RobotSystemPrompts(
        ...
        about_your_capabilities=(
            ...
            "\n"
            "Always execute commands using appropriate tools rather than describing actions."
        ),
        ...
        mission_and_objectives=(
            ...
            "you **must** immediately call the appropriate `get_robot_camera_image` tool for the specified robot. "
